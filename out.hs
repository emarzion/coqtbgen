...
init_TB :: (StringMap a1) -> Game -> FinGame -> TB a1
init_TB m_SM g g_fin =
  Build_TB O Abelard (empty0 m_SM) (empty0 m_SM) (enum_wins g g_fin Black)
...
final_TB :: (StringMap a1) -> Game -> (Show GameState) -> FinGame ->
            Reversible -> TB a1
final_TB m_SM g g_string g_fin g_rev =
